...
export const products: Product[] = [
  {
    ...
    description:
      "A complete shop management ERP for POS billing, purchases, stock, accounts, customers, suppliers, expenses, reports, WhatsApp automation, and cloud backup.",
    ...
    benefits: [
      "Run billing, purchases, stock, and accounts from one place",
      "Track daily sales, expenses, balances, and inventory clearly",
      "Send customer, supplier, and owner updates through WhatsApp",
      "Protect business data with optional or included cloud backup",
      "Scale from one counter user to a multi-user shop operation",
    ],
    plans: [
      {
        name: "Basic",
        description: "Core shop management for small shops starting digital operations.",
        price: "PKR 20,000 first year + PKR 10,000/year renewal",
        features: [
          "POS",
          "Purchase management",
          "Stock management",
          ...
          "Basic reports",
          "1 user included",
          "Small Powered by PANDAS branding",
          "Extra user add-on: PKR 3,000/year",
          "Cloud backup add-on: PKR 8,000/year",
        ],
      },
      {
        name: "Premium",
        description: "Automation and intelligence for shops that want the best-value package.",
        price: "PKR 35,000 first year + PKR 15,000/year renewal",
        highlighted: true,
        features: [
          "Everything in Basic",
          "Advanced reports",
          "WhatsApp messages to customers/suppliers",
          "WhatsApp automated daily reports",
          "AI chatbot",
          "Weekly cloud backup",
          "3 users included",
          "No bill watermark",
      ...
      {
        name: "Enterprise",
        description: "Safety, recovery, branding, collections, and priority support.",
        price: "PKR 50,000 first year + PKR 20,000/year renewal",
        features: [
          "Everything in Premium",
          "Daily cloud backup",
          "Backup restore support",
          "No bill watermark",
          "Weekly WhatsApp payment reminders to customers",
          "Custom WhatsApp reminder templates",
          "5-10 users included",
          "Priority support",
          "Custom invoice/bill format",
          "Custom branding/invoice design",
          "Data migration support",
          "WhatsApp reminders add-on available for other plans: PKR 5,000/year",
          "Custom report/invoice work: one-time custom quote",
        ],
      },
    ],
    faqs: [
